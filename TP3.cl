(defvar *questions* '(
  (1 "Un controle va avoir lieu bientot. Comment le préparez vous ?" ((1 "J'étudie beaucoup" ((hardi 2)))(2 "Au dernier instant" ((relax 2)))(3 "Je m'amuse" ((malin 2)))))
  ...
  (41 "Baïllez-vous souvent ?" ((1 "Oui" ((calme 2)(relax 1)))(2 "Non" ((hardi 1)(pressé 2)))))
...
;obtention de la liste ne possÃ©dant pas les caractÃ©ristiques entrÃ©es en arguments
...
;obtention de la liste possÃ©dant les caractÃ©ristiques entrÃ©es en arguments
...
;obtention de la liste de question avec seulement les caractÃ¨res entrÃ©es en arguments
;Dans notre traitement on pourra peut Ãªtre avec besoin de la fonction prÃ©cÃ©dente au cas oÃ¹ aucune question n'est renvoyÃ© ici
...
;obtention de caractÃ¨re en fonction d'une rÃ©ponse Ã  une question
...
;retourne le cractÃ¨re qui la le plus de points
...
;fonction service pour rÃ©cuperer les 5 questions avec le plus de points
...
(defun test()
  ...
  (setq nb_question 0)
  (setq deja_posee '())
  (setq carac_point '((bizarre 1)(jovial 1)(docile 0)(hardi 1)(calme 1)(brave 0)(relax 0)(malin 0)(solo 0)(naif 0)(timide 0)(malpoli 0)(pressé 0)))
  (while (< nb_question 4)
      (let ((reponse)(question_actuelle)(carac)(carac_elim))
        (setq question_actuelle (random_question liste_question))
        (push (car question_actuelle) deja_posee)
...
;programme principal
(defun principale ()
  (let ((questions)( carac_point '((bizarre 1)(jovial 1)(docile 0)(hardi 1)(calme 1)(brave 0)(relax 0)(malin 0)(solo 0)(naif 0)(timide 0)(malpoli 0)(pressé 0)))(carac_question)(deja_posee)(liste_question *questions*)(nb_question 4))
