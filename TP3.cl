...
(car (caddr '(Bulbizarre (docile) (calme))))
(defvar *pokemons* '(
...
(questions_avec_carac '(bizarre) *questions*)
(questions_carac_unique '(bizarre) *questions*)
(setq l (choix_question 31 *questions*))
(affiche_question l)
(get_reponse l)
(setq reponse (get_reponse l))
...
init
(setq c (assoc 'JOVIAL '((jovial 0)(bizarre 2))))
